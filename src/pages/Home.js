...
function Home() {
    return (
        <>
            ...
            <section className="featured-wapper py-5 home-wrapper-2">
                <div className="container-xxl">
                    <div className="col-12">
            ...
            <section className="popular-wapper py-5 home-wrapper-2">
                <div className="container-xxl">
                    <div className="col-12">
            ...
            <section className="marquee-warpper py-5">
                <div className="container-xxl">
                    <div className="row">
                        <div className="col-12">
            ...
            <section className="blog-wapper py-5 home-wrapper-2">
                <div className="container-xxl">
                    <div className="col-12">

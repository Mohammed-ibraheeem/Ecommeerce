                    ...
                    <div className="row">
                        ...
                        <div className="col-3">
                            ...
                            <div className='footer-links d-flex flex-column'>
                                <Link to="/Ecommeerce/privacy-policy" className='text-white py-2 mb-1'>Privacy Policy</Link>
                                <Link to="/Ecommeerce/refund-policy" className='text-white py-2 mb-1'>Refund Policy</Link>
                                <Link to="/Ecommeerce/shopping-pokicy" className='text-white py-2 mb-1'>Shopping Policy</Link>
                                <Link to="/Ecommeerce/terms-conditions" className='text-white py-2 mb-1'>Terms & Conditions</Link>
